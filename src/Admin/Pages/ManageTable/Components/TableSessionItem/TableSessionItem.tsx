  ...
  return (
    <Col xs={24} sm={12} md={8} lg={6} xl={6}>
      <Link
        ...
        className="block relative rounded-xl overflow-hidden cursor-pointer transition duration-300 hover:shadow-lg h-52"
      >
        <div
        ...
        {/* Overlay mờ tối để text nổi bật hơn (tuỳ chọn) */}
